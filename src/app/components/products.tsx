...
import { urlFor } from '@/sanity/lib/image'; // Adjust this import path as needed
      ...
      <Link href={`/product/${data.slug}`}>
        <a>
          <img
            ...
            src={data.imageUrl || '/default-image.png'} // Fallback image if URL is missing
            alt={data.name}
          />
        </a>
      </Link>
